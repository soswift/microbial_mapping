...
library(viridisLite)
library(vegan)
#library(RVAideMemoire) Memory intensive
...
# run permanovas using type 2 sum of squares
perm_aovs <- list()
...
permanova_output$R2  <- permanova_output$Sum.Sq/permanova_output$Sum.Sq[nrow(permanova_output)]
...
for(a_factor in c("empo_3","site_code","habitat")){
