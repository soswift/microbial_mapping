...
# filter by project
samples <- samples[project_name %in% c("Keck","JoshMS"),]
...
print(p)
ggsave(file = paste("../outputs/figures/summary", habitats[a],"_barplot.pdf",sep = ""),
...
p
# 
ggsave("../outputs/figures/summary/habitat_sample_type_circleplot.pdf",plot = p, device = "pdf", width = 15, height = 10, dpi = 400)
...
orca(fig, file = "../outputs/figures/summary/summary_sunburst.pdf",format ="pdf") 
```
